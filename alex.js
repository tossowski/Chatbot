...
// Adding Responses
generalRobotResponses.push("Hello, my name is Alex.")
...
reset_gif = function() {
    let gif = document.getElementById("Alex");
    gif.src = "./public/alex.gif"
}
...
window.onload = function() {
    ...
    responseButton.onclick = function() {
        ...
        let gif = document.getElementById("Alex");
        gif.src = "./public/talk.gif"
        setTimeout(function() { reset_gif(); }, cliplengths[idx] * 1000);
